        ...
        {#if !showResult}
            <div id="quiz">
                <div>
                    ...
                    <button on:click={() => checkAnswer(1, 'A')}>A) Preto</button>
                    <button on:click={() => checkAnswer(1, 'B')}>B) Azul</button>
                    <button on:click={() => checkAnswer(1, 'C')}>C) Verde</button>
                </div>

                <div>
                    <p><strong>2. Qual Foi o Primeiro Dia que Você Falou comigo?</strong></p>
                    <button on:click={() => checkAnswer(2, 'A')}>A) 17/07/2024</button>
                    <button on:click={() => checkAnswer(2, 'B')}>B) 18/06/2024</button>
                    <button on:click={() => checkAnswer(2, 'C')}>C) 23/7/2024</button>
                </div>

                <div>
                    <p><strong>3. Qual é minha Comida favorita?</strong></p>
                    <button on:click={() => checkAnswer(3, 'A')}>A) Strogonoff</button>
                    <button on:click={() => checkAnswer(3, 'B')}>B) Bolo</button>
                    <button on:click={() => checkAnswer(3, 'C')}>C) </button>
                </div>
            </div>
        {/if}
